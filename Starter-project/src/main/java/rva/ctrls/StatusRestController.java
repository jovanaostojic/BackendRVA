...
public class StatusRestController {
	...
	@ApiOperation(value = "Vraca kolekciju svih statusa iz baze podataka koji u nazivu sadrze string proslednjen kao PATH varijabla")
	...
	public ResponseEntity<Status> deleteStatus(@PathVariable("id") Integer id){
		...
		if(id==-100) {
			jdbcTemplate.execute("INSERT INTO status VALUES (-100, 'TestStatus','TS');");
		}
		return new ResponseEntity<Status>(HttpStatus.OK);
	}
}
